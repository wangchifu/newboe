...
<div class="col-lg-10 mx-auto">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form  action="{{ route('contents.update',$content->id) }}" method="post" id="content_form">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <a class="btn btn-secondary btn-sm" onclick="window.history.back();"><i class="fa-solid fa-backward"></i> 返回</a>
                    <a href="#!" class="btn btn-primary btn-sm" onclick="sw_confirm2('確定？','content_form')">儲存</a>
                </div>
            </form>                                   
        </div>
    </div>

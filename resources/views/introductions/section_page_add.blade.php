...
<div class="col-lg-12 mx-auto">
    ...
    <ul class="nav nav-tabs">
        ...
        @endforeach
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('introductions.section_page_add') }}"><i class="fas fa-plus-circle"></i> 頁面</a>
        </li>
    </ul>
    <br>
    <form action="{{ route('introductions.section_page_store') }}" method="post" id="store_form" onsubmit="return false">
        @csrf
        ...
        <div class="form-group">
            <a href="#!" class="btn btn-success btn-sm" onclick="sw_confirm2('確定儲存？','store_form')">儲存設定</a>
        </div>
    </form>       
    <br>    
</div>

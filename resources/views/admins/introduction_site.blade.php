...
<div class="col-lg-12 mx-auto">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admins.introduction_organization',$section_id) }}">業務簡介</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('admins.introduction_people',$section_id) }}">科室成員</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('admins.introduction_site',$section_id) }}">資源網站</a>
        </li>
    </ul>
    <br>

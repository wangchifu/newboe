...
<div class="col-lg-12 mx-auto">
    <h1>[{{ $sections[auth()->user()->section_id] }}]：<span class="badge bg-success"><i class="fas fa-edit"></i> 修改填報</span></h1>
    @include('edus.posts.nav')
    <div class="card my-4">
        <div class="card-header">     
            <i class="fa-solid fa-list"></i> 修改 [{{ $sections[auth()->user()->section_id] }}] 填報                   
        </div>
        <div class="card-body">

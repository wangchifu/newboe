...
<div class="col-lg-12 mx-auto">
    <h1>[教育處]：<span class="badge border border-primary text-primary bg-white"><i class="fas fa-list"></i> 全數公告</span></h1>
        @include('edus.posts.nav')                 
        <div class="card my-4">
            <div class="card-header text-center">
                <form action="{{ route('posts.do_search') }}" method="post" id="this_form">
                    @csrf                    
